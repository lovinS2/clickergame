...
const images = ["gaon.png",py.webp , "https://github.com/lovinS2/clickergame/blob/main/js.png?raw=true", "c.png", "ja.png", "luby.png", "umm.png", "php.png"];
const stories = [
    "가온이가 코딩을 배우기 시작했어!",
    "가온이가 변수와 자료형을 배웠어!",
    "가온이가 반복문을 이해했어!",
...
function chooseFail() {
    ...
    // 버튼 이미지 변경
    document.getElementById("gaonImage").src = "/clickgame/main/poop.webp"; // 실패 이미지
...
function showFinalStage() {
    ...
    // 버튼 이미지 변경
    document.getElementById("gaonImage").src = "./main/happy.jpg"; // 성공 이미지
